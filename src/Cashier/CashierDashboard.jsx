...
import CashierOverview from "./CashierOverview"; // Import the overview component
...
function CashierDashboard() {
  ...
  const menuItems = [
    ...
    { id: "payment-processing", label: "Payment Processing", icon: FaMoneyBillWave },
    { id: "receipt-management", label: "Receipt Management", icon: FaReceipt },
    { id: "financial-reports", label: "Financial Reports", icon: FaFileInvoiceDollar },
    { id: "payment-types", label: "Payment Types", icon: FaCreditCard },
    { id: "profile", label: "My Profile", icon: FaUserCircle },
    { id: "logout", label: "Sign Out", icon: FaSignOutAlt }
  ];
  ...
  const renderContent = () => {
    switch (active) {
      case "Dashboard":
        return <CashierOverview />; // Use the imported component
      ...
      case "Sign Out":
        return (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Signing Out</h3>
      ...
      <main className="flex-1 p-6 overflow-auto">
        <header className="mb-6">
          ...
          <p className="text-gray-600">
            {active === "Dashboard" && "Overview of financial activities and transactions"}
            {active === "Payment Processing" && "Process various types of payments"}
            {active === "Financial Reports" && "Generate and view financial reports"}
            {active === "Receipt Management" && "Manage receipt generation and tracking"}
            {active === "Payment Types" && "Configure and manage payment methods"}
            {active === "My Profile" && "Update your personal information"}
            {active === "Sign Out" && "Secure session termination"}
          </p>
        </header>
